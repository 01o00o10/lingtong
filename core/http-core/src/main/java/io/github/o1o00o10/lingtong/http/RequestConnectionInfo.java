...
public final class RequestConnectionInfo {
  ...
  public RequestConnectionInfo(
      ...
      String serverName,
      int serverPort) {
    this(remoteAddress, remotePort, localAddress, localPort, scheme, serverName, serverPort, null);
  }
  ...
  public static RequestConnectionInfo local(HttpHeaders headers) {
    ...
    return new RequestConnectionInfo(
        "127.0.0.1", 0, "127.0.0.1", authority.port, "http", authority.host, authority.port);
  }
  ...
  public static Authority authority(String value, int defaultPort) {
    ...
    if (authority.charAt(0) == '[') {
      ...
      int port =
          closing + 1 < authority.length() && authority.charAt(closing + 1) == ':'
