...
public final class HttpResponse {
  ...
  public HttpResponse(
      int status, String reason, HttpHeaders headers, byte[] body, ConnectionUpgrade upgrade) {
    this(status, reason, headers, body, EMPTY_HEADERS, upgrade);
  }

  public HttpResponse(
      int status, String reason, HttpHeaders headers, byte[] body, HttpHeaders trailers) {
