...
public final class LingTongDefaultServerEndpointConfigurator
    ...
    @Override public String getNegotiatedSubprotocol(
            List<String> supported, List<String> requested) {
    ...
    @Override public boolean checkOrigin(String originHeaderValue) { return true; }
    ...
    @Override public <T> T getEndpointInstance(Class<T> endpointClass)
        ...
        try {
            ...
            InstantiationException failure = new InstantiationException(
                    "cannot access endpoint " + endpointClass.getName());
            failure.initCause(e);
            throw failure;
        }
    }
