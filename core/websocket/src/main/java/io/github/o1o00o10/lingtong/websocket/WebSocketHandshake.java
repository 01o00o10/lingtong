...
public final class WebSocketHandshake {
  ...
  public static HttpResponse accept(
      HttpRequest request, WebSocketHandler handler, Executor executor, int maxMessageBytes) {
    ...
    String subprotocol =
        selectSubprotocol(request.headers().all("sec-websocket-protocol"), handler.subprotocols());
    boolean compressed =
