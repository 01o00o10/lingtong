...
public final class TlsConfig {
    ...
    public TlsConfig(
            ...
            int maxBufferBytes) {
        this(sslContext, clientAuth, protocols, cipherSuites, handshakeTimeoutMillis,
                maxBufferBytes, AlpnProvider.jdk());
    }
    ...
    public TlsConfig(
        ...
        if (clientAuth == null || protocols == null || cipherSuites == null
                || handshakeTimeoutMillis <= 0L || maxBufferBytes <= 0 || alpnProvider == null) {
