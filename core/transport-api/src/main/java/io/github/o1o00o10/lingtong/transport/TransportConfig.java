...
public final class TransportConfig {
    ...
    public TransportConfig(
            ...
            int maxHeaderBytes,
            int maxBodyBytes) {
        this("127.0.0.1", port, ioShards, readBufferSize, buffersPerShard,
                commandQueueCapacity, maxHeaderBytes, maxBodyBytes,
                DEFAULT_REQUEST_HEADER_TIMEOUT_MILLIS, DEFAULT_IDLE_TIMEOUT_MILLIS,
                DEFAULT_MAX_REQUESTS_PER_CONNECTION, CompressionConfig.disabled());
    }
    ...
    public TransportConfig(
            ...
            int maxHeaderBytes,
            int maxBodyBytes) {
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard,
                commandQueueCapacity, maxHeaderBytes, maxBodyBytes,
                DEFAULT_REQUEST_HEADER_TIMEOUT_MILLIS, DEFAULT_IDLE_TIMEOUT_MILLIS,
                DEFAULT_MAX_REQUESTS_PER_CONNECTION, CompressionConfig.disabled());
    }
    ...
    public TransportConfig(
        ...
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard, commandQueueCapacity,
                maxHeaderBytes, maxBodyBytes, requestHeaderTimeoutMillis, idleTimeoutMillis,
                maxRequestsPerConnection, CompressionConfig.disabled());
    }
    ...
    public TransportConfig(
        ...
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard, commandQueueCapacity,
                ...
                requestHeaderTimeoutMillis, idleTimeoutMillis, maxRequestsPerConnection, compression,
    ...
    public TransportConfig(
            ...
            CompressionConfig compression) {
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard, commandQueueCapacity,
                maxHeaderBytes, maxBodyBytes, requestBodyBufferBytes, requestBodyLowWaterBytes,
                requestHeaderTimeoutMillis, idleTimeoutMillis, maxRequestsPerConnection,
                compression, ProxyConfig.disabled());
    }
    ...
    public TransportConfig(
        ...
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard, commandQueueCapacity,
                maxHeaderBytes, maxBodyBytes, requestBodyBufferBytes, requestBodyLowWaterBytes,
                requestHeaderTimeoutMillis, idleTimeoutMillis, maxRequestsPerConnection,
                compression, proxy, DEFAULT_MAX_HEADER_COUNT, DEFAULT_MAX_TRAILER_BYTES,
                DEFAULT_MAX_TRAILER_COUNT, TlsConfig.disabled());
    }
    ...
    public TransportConfig(
        ...
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard, commandQueueCapacity,
                maxHeaderBytes, maxBodyBytes, requestBodyBufferBytes, requestBodyLowWaterBytes,
                requestHeaderTimeoutMillis, idleTimeoutMillis, maxRequestsPerConnection,
                compression, proxy, maxHeaderCount, maxTrailerBytes, maxTrailerCount,
                TlsConfig.disabled());
    }
    ...
    public TransportConfig(
        ...
        this(bindAddress, port, ioShards, readBufferSize, buffersPerShard,
                commandQueueCapacity, maxHeaderBytes, maxBodyBytes,
                requestBodyBufferBytes, requestBodyLowWaterBytes,
                requestHeaderTimeoutMillis, idleTimeoutMillis, maxRequestsPerConnection,
                compression, proxy, maxHeaderCount, maxTrailerBytes, maxTrailerCount,
                tls, false);
    }
    ...
    public TransportConfig(
        ...
        if (ioShards <= 0 || readBufferSize <= 0 || buffersPerShard <= 0
                || commandQueueCapacity <= 0 || maxHeaderBytes <= 0 || maxBodyBytes < 0
                || requestBodyBufferBytes <= 0 || requestBodyLowWaterBytes < 0
                || requestBodyLowWaterBytes >= requestBodyBufferBytes
                || requestHeaderTimeoutMillis <= 0 || idleTimeoutMillis <= 0
                || maxRequestsPerConnection <= 0 || compression == null || proxy == null
                || tls == null
                || maxHeaderCount <= 0 || maxTrailerBytes <= 0 || maxTrailerCount < 0) {
