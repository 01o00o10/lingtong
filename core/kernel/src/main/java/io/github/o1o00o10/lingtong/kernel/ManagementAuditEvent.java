...
public final class ManagementAuditEvent {
    ...
    public ManagementAuditEvent(long timestampMillis, String remoteAddress, String role,
            String method, String path, int status, String outcome) {
        if (remoteAddress == null || role == null || method == null || path == null
                || outcome == null || status < 100 || status > 599) {
