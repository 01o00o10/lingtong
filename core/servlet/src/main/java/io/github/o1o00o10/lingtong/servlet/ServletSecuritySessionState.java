...
final class ServletSecuritySessionState {
  ...
  ServletSecuritySessionState(ServletSecurityIdentity identity, String authenticationType) {
  ...
  static final class SavedRequest {
    ...
    SavedRequest(
        String method, String requestUri, String queryString, Map<String, String[]> parameters) {
      this.method = method;
