...
final class ComponentConfigs {
    ...
    static ServletConfig servlet(String name, ServletContext context, Map<String, String> initParameters) {
        final Map<String, String> parameters = Collections.unmodifiableMap(
    ...
    static FilterConfig filter(String name, ServletContext context, Map<String, String> initParameters) {
        final Map<String, String> parameters = Collections.unmodifiableMap(
                new LinkedHashMap<String, String>(initParameters));
