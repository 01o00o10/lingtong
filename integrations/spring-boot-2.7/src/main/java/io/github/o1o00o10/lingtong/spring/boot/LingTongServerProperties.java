...
public class LingTongServerProperties {
  ...
  public void setClusterPeers(List<String> clusterPeers) {
    this.clusterPeers = clusterPeers;
  }

  public Duration getClusterHeartbeat() {
  ...
  public int getClusterFailureThreshold() {
    return clusterFailureThreshold;
  }
  ...
  public String getManagementOperatorToken() {
    return managementOperatorToken;
  }
  ...
  public Path getManagementAuditFile() {
    return managementAuditFile;
  }
  ...
  public DataSize getManagementAuditMaxSize() {
    return managementAuditMaxSize;
  }

  public void setManagementAuditMaxSize(DataSize value) {
    managementAuditMaxSize = value;
  }

  public int getManagementAuditRetainedFiles() {
    return managementAuditRetainedFiles;
  }
