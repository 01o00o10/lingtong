...
public interface WebSocketHandler {
    ...
    default void onTextFragment(
            WebSocketSession session, String fragment, boolean last) throws Exception {
    }
    ...
    default void onBinaryFragment(
            WebSocketSession session, ByteBuffer fragment, boolean last) throws Exception {
    }
